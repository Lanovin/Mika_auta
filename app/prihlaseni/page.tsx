    ...
    <div className="container-page py-16">
      <div className="mx-auto grid max-w-5xl gap-8 lg:grid-cols-[minmax(0,1fr),minmax(0,1fr)]">
        <section className="rounded-3xl bg-slate-950 p-8 text-white shadow-soft">
          <p className="text-xs font-semibold uppercase tracking-[0.25em] text-slate-300">Účet a přihlášení</p>
          ...
          <div className="mt-8 text-sm text-slate-300">
            Po přihlášení administrátora se zpřístupní i stránka <Link href="/admin" className="font-semibold text-white underline underline-offset-4">správy vozů</Link>.
          </div>
        </section>
        ...
        <section className="grid gap-6">
          ...
          <div className="rounded-3xl bg-white p-8 shadow-soft ring-1 ring-slate-100">
            ...
            <form action={loginUserAction} className="mt-6 space-y-4">
              ...
              <button type="submit" className="inline-flex w-full items-center justify-center rounded-full bg-primary px-4 py-2.5 text-sm font-semibold text-white shadow-soft transition hover:bg-primary-dark">
                Přihlásit se
              </button>
            </form>
          </div>
          ...
          <div className="rounded-3xl bg-white p-8 shadow-soft ring-1 ring-slate-100">
            ...
            <form action={registerUserAction} className="mt-6 grid gap-4">
              ...
              <button type="submit" className="inline-flex w-full items-center justify-center rounded-full border border-slate-200 px-4 py-2.5 text-sm font-semibold text-slate-800 transition hover:bg-slate-50">
                Vytvořit účet
              </button>
            </form>
          </div>
