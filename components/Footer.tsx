        ...
        <div style={{ display: 'grid', gap: '40px', gridTemplateColumns: 'repeat(3, 1fr)' }} className="footer-grid">
          ...
          <div>
            ...
            <div style={{ fontSize: '13px', color: 'var(--text-muted)', lineHeight: 1.8 }}>
              <div>{k.address.street}</div>
              <div>{k.address.city}</div>
              <div>{k.address.note1}</div>
            </div>
            ...
            <div style={{ fontSize: '13px', color: 'var(--text-muted)', lineHeight: 1.8 }}>
              <div>{k.hours.weekdays}</div>
              <div>{k.hours.saturday}</div>
              <div>{k.hours.sunday}</div>
            </div>
          </div>
